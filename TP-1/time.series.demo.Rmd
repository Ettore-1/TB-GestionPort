...
get.src.folder <- function() {
  path.expand("/Users/ettorehidoux/Desktop/Gestion de Portefeuille & Algorithme de Trading/TB-GestionPort/GP/src")
}

get.data.folder <- function() {
  path.expand("/Users/ettorehidoux/Desktop/Gestion de Portefeuille & Algorithme de Trading/TB-GestionPort/GP/data")
}
```
...
```{r, echo=TRUE}
ts.zc <- get.ts(folder="CAC40", ticker="ac.pa")
```
...
ts.EuroStoxx50 <- get.all.ts(folder="CAC40", returns=TRUE, combine=TRUE)
...
knitr::kable(list(avg.ret.table[1:n.mid,], avg.ret.table[(n.mid+1):n.rows,]), 
             ...
             caption="Rendement annuel moyen des actions du CAC40",
...
ts.all <- get.all.ts(
  folder='CAC40', tickers=NULL, returns = FALSE,
...
knitr::kable(rbind(head(sorted.good.df, 10), tail(sorted.good.df,10)),
             ...
             caption="CAC40: meilleurs et pires rendements annuels moyens", 
